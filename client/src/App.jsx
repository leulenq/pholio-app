        ...
        <Routes>
          ...
          <Route element={<AgencySessionGate />}>
            ...
            <Route element={<AgencyLayout />}>
              ...
              <Route path="/dashboard/agency/boards" element={<Navigate to="/dashboard/agency/casting" replace />} />
              <Route path="/dashboard/agency/roster" element={<AgencyRoster />} />
              <Route path="/dashboard/agency/signed" element={<Navigate to="/dashboard/agency/roster" replace />} />
