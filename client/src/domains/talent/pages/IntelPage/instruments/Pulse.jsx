...
import { CountUp, Calibrating, SPRING, TIER_RAMP, TIER_META, nf, pct } from './parts';
...
function useCount(reviews, advances, pulls) {
  return reviews + advances + pulls;
}
...
function Headline({ headline, periodLabel }) {
  ...
  const meaningful = useCount(reviews, advances, pulls);
