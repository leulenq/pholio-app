...
const walletRouter = require("../../wallet/routes/talent-wallet");
const compCardImportRouter = require("./comp-card-import");
const externalCompCardsRouter = require("./external-comp-cards");
...
router.use("/api/talent/external-comp-cards", externalCompCardsRouter);
...
router.use("/api/talent/wallet", walletRouter);
