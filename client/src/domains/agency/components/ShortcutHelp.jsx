...
const SHORTCUTS = [
  ...
  { keys: ['A'], label: 'Offer — press again or Enter to confirm' },
  { keys: ['X'], label: 'Pass — press again or Enter to confirm' },
  { keys: ['F'], label: 'Keep on file (in review)' },
  { keys: ['D'], label: 'Request digitals (in review)' },
  { keys: ['M'], label: 'Invite to a go-see (in review)' },
  { keys: ['N'], label: 'Jot a house note (in review)' },
  { keys: ['U'], label: 'Reopen a decided submission (in review)' },
