 ...
 *
 * Slugs map to profiles. Comp cards and digitals sheets are casting assets
 * and talent dashboard tools, not public web portfolios; they are not gated
 * by `is_public` (the web portfolio visibility toggle). Child-performer
 * protection (`minorPublicExposureAllowed`) is enforced at the route level.
 *
 * @param {string} slug
