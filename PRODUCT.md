...
Both surfaces are used at a desk, in good light, often for extended working sessions. The platform also has a separate Next.js marketing site (`pholio-site` repo) which is the brand gold-standard but is out of scope for these app design systems.
